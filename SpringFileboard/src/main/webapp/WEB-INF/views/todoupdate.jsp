...
<body>
	<form action="todoupdateOk" method="post" onsubmit="return formCheck();">
		<%-- 몇가지는 숨겨서 가자!!! --%>
		...
		<table style="border: 1px; text-align: center;">
           ...
           <tr> 
            <td colspan="4" align="right" style="text-align: center;border: none;">
             <input type="submit" value="Modify" class="btn btn-outline-primary btn-sm">
