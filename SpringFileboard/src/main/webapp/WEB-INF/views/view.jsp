	...
	<table style="border: 1px;text-align: center;">
			...
			<td align="left" colspan="3" id="fileList">
				...
				<c:if test="${vo.fileCount>0 }">
					<c:forEach var="fvo" items="${vo.fileList }">
						<a href="${pageContext.request.contextPath }/download?of=${fvo.oFile}&sf=${fvo.sFile}" title="${fvo.oFile }">${fvo.oFile }</a>
					</c:forEach>
				</c:if>
			</td>
		</tr>
		...
		<tr>
			<td colspan="4" align="right" style="text-align: center;border: none;">
				<input type="button" value="수정하기" readonly="readonly" class="btn btn-outline-primary btn-sm" 
